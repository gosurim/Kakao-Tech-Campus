    ...
    public static void main(String[] args) {
        ...
        while (flag2) {
            ...
            do{
                ...
                tempArr.add(rslt);
                System.out.println(num1 + " " + sign + " " + num2 + " = " + rslt);
            ...
            while(true){
                ...
                if (temp==1) System.out.println(tempArr);
                    ...
                    if (!cal.getArr().isEmpty()){
                        System.out.print("기준 값 입력: ");
                        double k = sc.nextDouble();
                        List<Double> bigger = cal.bigg(k);
                        System.out.println("검색 결과: " + bigger);
                    }else System.out.println("저장된 데이터가 없습니다.");
                }
                else if (temp==6) break;
            }
